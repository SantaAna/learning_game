defmodule Games.ConnectFour.ComputerPlayer do
  alias Games.ConnectFour.Board
  alias Games.ConnectFour
  ...
  def minimax(board) do
    ...
    {ret, _} = minimax(board, cache_pid, {10, 0})
  ...
  def minimax(board, cache_pid, scry, turn \\ :black) do
    ...
    case [free_cols, turn, ConnectFour.winner(%ConnectFour{board: board}), scry] do
