defmodule Games.GuessingGame.Display do
  ...
  def instructions(max_number \\ 10) do
    [
      ...
      "\n",
      "* If you guess too low: ", Owl.Data.tag("too low", :yellow),
      "\n",
      "* If you guess too high: ", Owl.Data.tag("too high", :yellow),
    ]
  ...
  def get_user_input(max_number \\ 10) do
    Owl.IO.input(label: "Enter a guess between 1 and #{max_number}", cast: {:integer, min: 1, max: max_number}) 
  end
